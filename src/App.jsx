...
function HomePage({ onNavigate }) {
  ...
  return <main>
    ...
    <div className="page-shell">
      ...
      <section className="about-card" id="about" data-reveal><img src="/assets/about-forest.png" alt="雾气中的针叶林" /><div className="about-content"><p className="eyebrow dark-label">ABOUT THIS BLOG</p><h2>关于这个博客</h2><p>这里主要分享计算机学习、技术文章和个人项目，也记录那些值得复盘的实现过程。</p><ArrowLink onClick={() => onNavigate("/articles")}>浏览文章索引</ArrowLink></div></section>
